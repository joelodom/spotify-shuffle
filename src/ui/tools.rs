        ...
        egui::ScrollArea::vertical()
            ...
            .show(ui, |ui| {
                ui.horizontal(|ui| {
                    ...
                    self.source_picker(ui, "tools-source");
                ...
                ui.group(|ui| {
                    ...
                    ui.label(
                        egui::RichText::new(
                            "Fisher–Yates with a ChaCha20 CSPRNG — every ordering equally likely, \
                         unlike Spotify's own shuffle. Always writes a NEW playlist; perfect \
                         for Liked Songs.",
                        )
                        .weak()
                        .small(),
                ...
                ui.group(|ui| {
                    ...
                    ui.label(
                        egui::RichText::new(
                         ...
                         for new apps in Nov 2024, and hides popularity in development mode.",
                        )
                        .weak()
                        .small(),
                    );
                ...
                ui.group(|ui| {
                    ...
                    ui.label(
                        egui::RichText::new(
                            "One `Artist - Title` per line (also accepts — or TAB).",
                        )
                        .weak()
                        .small(),
                    );
                ...
                ui.group(|ui| {
                    ...
                    ui.label(
                        egui::RichText::new(
                            "Save the working source as CSV or JSON — playlist backups survive \
                         anything Spotify does to your account.",
                        )
                        .weak()
                        .small(),
                    );

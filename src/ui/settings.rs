...
//! connection management. The editable state is a draft `AppConfig`; nothing
//! takes effect until "Apply & save".
        ...
        egui::ScrollArea::vertical()
            ...
            .show(ui, |ui| {
                ui.group(|ui| {
                    ...
                    ui.label(
                        egui::RichText::new(
                            "Note: Spotify refresh tokens expire ~6 months after authorization \
                         (policy since June 2026) — reconnect when prompted. Development-mode \
                         apps require the owner to have Premium and allow at most 5 users.",
                        )
                        .weak()
                        .small(),
                    );
                            ...
                            match self.cfg_draft.ai.provider {
                                AiProviderKind::ClaudeCode => {
                                    ...
                                    ui.add(
                                        ...
                                        .hint_text(
                                            "empty = your CLI's default (sonnet/opus/haiku/fable)",
                                        )
                                        .desired_width(280.0),
                                    );
                                    ui.end_row();
                                    ...
                                    ui.add(
                                        ...
                                        .hint_text("empty = auto-detect on PATH + known locations")
                                        .desired_width(280.0),
                                    );
                                    ui.end_row();
